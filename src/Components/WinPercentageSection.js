...
class WinPercentageSection extends React.Component {
  ...
  winPercentageObjs = (heroes, records) => {
    let arr = [];
    for (var i in heroes) {
      var obj = {
        ImgSrc: require("../css/images/Icon-" +
          heroes[i].Name.toLowerCase() +
          ".png"),
        Name: heroes[i].Name,
        Type: heroes[i].Type,
        Win: 0,
    ...
    return (
      <Article>
        <Box
          ...
          align="center"
        >
          <Heading strong={true} uppercase={true} truncate={false} tag="h3">
            Competitive Section
          </Heading>
        ...
        <Box
          ...
          wrap={true}
        >
          {this.winPercentageObjs(
            this.props.heroes,
            this.props.competitiveFilteredData
          )}
        </Box>
        <Box
          direction="column"
        ...
        >
          {this.winPercentageObjs(
            this.props.heroes,
            this.props.quickplayFilteredData
          )}
        </Box>
      </Article>
    );
